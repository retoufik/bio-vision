...
export default function Footer() {
  return (
    <footer style={{ borderTop: '1px solid #e5e7eb', padding: 16, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
      ...
      <button style={{ display: 'inline-flex', alignItems: 'center', gap: 8, fontWeight: 800, color: '#101011ff', backgroundColor: 'rgba(101, 25, 201, 1)', border: 'none', borderRadius: 8, padding: '8px 16px' }}>
